...
public class ConfigHandler 
{
   ...
   private final MACViewer plugin;

   public ConfigHandler(MACViewer plugin) 
   {
      this.plugin = plugin;      
   ...
   public void reloadConfig(CommandSender sender)
   {
      ...
      sender.sendMessage(MACViewer.logPrefix + plugin.getDescription().getName() + " " + plugin.getDescription().getVersion() + " reloaded!");       
   } 
}
